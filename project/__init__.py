...
def create_app():
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://{user}:{password}@{server}/{database}'.format(user='username', password='XXXXXXXXXX', server='xx.xx.xx.xx', database='databasename')
